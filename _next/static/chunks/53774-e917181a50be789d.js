    ...
    [53774], {
        ...
        51050: function(t, e, n) {
            ...
            let o = async (t, e, n) => {
                let {
                    ...
                    middleware: l = [],
                    platform: u
                } = n, f = l.filter(Boolean), c = await (null == u.isRTL ? void 0 : u.isRTL(e)), a = await u.getElementRects({
                    reference: t,
                    floating: e,
                    strategy: o
                }), {
                ...
                for (let n = 0; n < f.length; n++) {
                    ...
                    s = null != w ? w : s, d = null != y ? y : d, h = { ...h,
                        [l]: { ...h[l],
                            ...x
                        }
                    }, v && m <= 50 && (m++, "object" == typeof v && (v.placement && (p = v.placement), v.rects && (a = !0 === v.rects ? await u.getElementRects({
                        reference: t,
                        floating: e,
                        strategy: o
                    }) : v.rects), {
            ...
            async function l(t, e) {
                ...
                let {
                    ...
                    altBoundary: p = !1,
                    padding: h = 0
                } = (0, r.ku)(e, t), m = (0, r.yd)(h), g = f[p ? "floating" === d ? "reference" : "floating" : d], w = (0, r.JB)(await l.getClippingRect({
            ...
            async function c(t, e) {
                let {
                    ...
                    platform: i,
                    elements: o
                } = t, l = await (null == i.isRTL ? void 0 : i.isRTL(o.floating)), u = (0, r.k3)(n), f = (0, r.hp)(n), c = "y" === (0, r.Qq)(n), a = ["left", "top"].includes(u) ? -1 : 1, s = l && c ? -1 : 1, d = (0, r.ku)(e, t), {
                    mainAxis: p,
                    crossAxis: h,
                    alignmentAxis: m
                } = "number" == typeof d ? {
                ...
                return f && "number" == typeof m && (h = "end" === f ? -1 * m : m), c ? {
                    x: h * s,
                    y: p * a
                } : {
                    x: p * a,
            ...
            function g(t, e, n, i) {
                ...
                let c = (void 0 === (o = n) && (o = !1), i && (!o || i === (0, a.Jj)(u)) && o) ? m(u) : (0, r.ze)(0),
                    s = (l.left + c.x) / f.x,
                    h = (l.top + c.y) / f.y,
                    g = l.width / f.x,
                    w = l.height / f.y;
                if (u) {
                    ...
                    for (; r && i && e !== n;) {
                        ...
                        s *= t.x, h *= t.y, g *= t.x, w *= t.y, s += o, h += l, n = (0, a.Jj)(r), r = (0, a.wK)(n)
                    }
                }
                return (0, r.JB)({
                    width: g,
            ...
            function x(t, e, n) {
                ...
                if ("viewport" === e) i = function(t, e) {
                    ...
                    if (i) {
                        ...
                        let t = (0, a.Pf)();
                        (!t || t && "fixed" === e) && (u = i.offsetLeft, f = i.offsetTop)
                    }
                    return {
                        width: o,
                        height: l,
                    ...
                    let e = (0, a.tF)(t),
                        ...
                        u = -n.scrollLeft + w(t),
                        f = -n.scrollTop;
                    return "rtl" === (0, a.Dx)(i).direction && (u += (0, r.Fp)(e.clientWidth, i.clientWidth) - o), {
                        width: o,
                        height: l,
                        x: u,
                        y: f
                ...
                else if ((0, a.kK)(e)) i = function(t, e) {
                    let n = g(t, !0, "fixed" === e),
                        i = n.top + t.clientTop,
            ...
            function R(t, e) {
                ...
                if (!(0, a.Re)(t)) {
                    let e = (0, a.Ow)(t);
                    for (; e && !(0, a.Py)(e);) {
                        if ((0, a.kK)(e) && !v(e)) return e;
                        e = (0, a.Ow)(e)
                    }
                    return n
                }
                let r = b(t, e);
                for (; r && (0, a.Ze)(r) && v(r);) r = b(r, e);
                return r && (0, a.Py)(r) && v(r) && !(0, a.hT)(r) ? n : r || (0, a.gQ)(t) || n
            }
                    ...
                    return {
                        reference: function(t, e, n) {
                            let i = (0, a.Re)(e),
                                ...
                                c = (0, r.ze)(0);
                            if (i || !i && !l) {
                                if (("body" !== (0, a.wk)(e) || (0, a.ao)(o)) && (f = (0, a.Lw)(e)), i) {
                                    let t = g(e, !0, l, e);
                ...
                L = {
                    convertOffsetParentRelativeRectToViewportRelativeRect: function(t) {
                        let {
                            ...
                            offsetParent: i,
                            strategy: o
                        } = t, l = "fixed" === o, u = (0, a.tF)(i), f = !!e && (0, a.tR)(e.floating);
                        if (i === u || f && l) return n;
                        let c = {
                                scrollLeft: 0,
                                scrollTop: 0
                            ...
                            d = (0, r.ze)(0),
                            h = (0, a.Re)(i);
                        if ((h || !h && !l) && (("body" !== (0, a.wk)(i) || (0, a.ao)(u)) && (c = (0, a.Lw)(i)), (0, a.Re)(i))) {
                            let t = g(i);
                    ...
                    getClippingRect: function(t) {
                        let {
                            ...
                            rootBoundary: i,
                            strategy: o
                        } = t, l = [..."clippingAncestors" === n ? (0, a.tR)(e) ? [] : function(t, e) {
                            let n = e.get(t);
                            if (n) return n;
                            let r = (0, a.Kx)(t, [], !1).filter(t => (0, a.kK)(t) && "body" !== (0, a.wk)(t)),
                                i = null,
                            ...
                            for (;
                                ...
                                let e = (0, a.Dx)(l),
                                    n = (0, a.hT)(l);
                                n || "fixed" !== e.position || (i = null), (o ? !n && !i : !n && "static" === e.position && !!i && ["absolute", "fixed"].includes(i.position) || (0, a.ao)(l) && !n && function t(e, n) {
                                    let r = (0, a.Ow)(e);
                                    return !(r === n || !(0, a.kK)(r) || (0, a.Py)(r)) && ("fixed" === (0, a.Dx)(r).position || t(r, n))
                                }(t, l)) ? r = r.filter(t => t !== l) : i = e, l = (0, a.Ow)(l)
                            }
                            return e.set(t, r), r
                        }(e, this._c) : [].concat(n), i], u = l[0], f = l.reduce((t, n) => {
                            let i = x(e, n, o);
            ...
            function T(t, e, n, i) {
                ...
                let m = p && c ? function(t, e) {
                        ...
                        return ! function u(f, c) {
                            ...
                            let m = (0, r.GW)(d),
                                ...
                                w = {
                                    rootMargin: -m + "px " + -g + "px " + -(0, r.GW)(o.clientHeight - (d + h)) + "px " + -(0, r.GW)(s) + "px",
                            ...
                            function x(e) {
                                ...
                                1 !== r || F(a, t.getBoundingClientRect()) || u(), y = !1
                            }
                            try {
                ...
                f && (y = new ResizeObserver(t => {
                    let [r] = t;
                    r && r.target === p && y && (y.unobserve(e), cancelAnimationFrame(w), w = requestAnimationFrame(() => {
                        var t;
                        null == (t = y) || t.observe(e)
                    })), n()
                }), p && !s && y.observe(p), y.observe(e));
                let x = s ? g(t) : null;
                return s && function e() {
                    let r = g(t);
                    ...
                    var t;
                    h.forEach(t => {
                        l && t.removeEventListener("scroll", n), u && t.removeEventListener("resize", n)
                    }), null == m || m(), null == (t = y) || t.disconnect(), y = null, s && cancelAnimationFrame(o)
                }
            }
            let A = l,
                D = function(t) {
                    ...
                    return void 0 === t && (t = {}), {
                        ...
                        async fn(e) {
                            let {
                                ...
                                x: n,
                                y: i
                            }, d = await l(e, a), p = (0, r.Qq)((0, r.k3)(o)), h = (0, r.Rn)(p), m = s[h], g = s[p];
                            if (u) {
                                let t = "y" === h ? "top" : "left",
                                    e = "y" === h ? "bottom" : "right",
                                    n = m + d[t],
                    ...
                    return void 0 === t && (t = {}), {
                        ...
                        async fn(e) {
                            ...
                            let R = (0, r.k3)(c),
                                ...
                                T = w || (L || !v ? [(0, r.pw)(d)] : (0, r.gy)(d)),
                                A = "none" !== x;
                            !w && A && T.push(...(0, r.KX)(d, v, x, F));
                            let D = [d, ...T],
                                E = await l(e, b),
                                O = [],
                            ...
                            if (P = [...P, {
                                ...
                                let n = null == (u = P.filter(t => t.overflows[0] <= 0).sort((t, e) => t.overflows[1] - e.overflows[1])[0]) ? void 0 : u.placement;
                                if (!n) switch (y) {
                                    case "bestFit":
                                        {
                                            let t = null == (f = P.filter(t => {
                                                if (A) {
                    ...
                    return void 0 === t && (t = {}), {
                        ...
                        async fn(e) {
                            ...
                            let {
                                ...
                                apply: d = () => {},
                                ...p
                            } = (0, r.ku)(t, e), h = await l(e, p), m = (0, r.k3)(f), g = (0, r.hp)(f), w = "y" === (0, r.Qq)(f), {
                                width: y,
                                height: x
                            } = c.floating;
                            "top" === m || "bottom" === m ? (o = m, u = g === (await (null == a.isRTL ? void 0 : a.isRTL(s.floating)) ? "start" : "end") ? "left" : "right") : (u = m, o = "end" === g ? "top" : "bottom");
                            let v = x - h.top - h.bottom,
                                b = y - h.left - h.right,
                                R = (0, r.VV)(x - h[o], v),
                                k = (0, r.VV)(y - h[u], b),
                                ...
                                F = R,
                                T = k;
                            if (null != (n = e.middlewareData.shift) && n.enabled.x && (T = b), null != (i = e.middlewareData.shift) && i.enabled.y && (F = v), L && !g) {
                                let t = (0, r.Fp)(h.left, 0),
                                    e = (0, r.Fp)(h.right, 0),
                                    n = (0, r.Fp)(h.top, 0),
                                    i = (0, r.Fp)(h.bottom, 0);
                                w ? T = y - 2 * (0 !== t || 0 !== e ? t + e : (0, r.Fp)(h.left, h.right)) : F = x - 2 * (0 !== n || 0 !== i ? n + i : (0, r.Fp)(h.top, h.bottom))
                            }
                            await d({ ...e,
                                availableWidth: T,
                                availableHeight: F
                ...
                V = t => ({
                    ...
                    async fn(e) {
                        ...
                        let d = (0, r.yd)(s),
                            ...
                            v = p[h] - l.reference[h],
                            b = await (null == u.getOffsetParent ? void 0 : u.getOffsetParent(a)),
                            R = b ? b[y] : 0;
                        R && await (null == u.isElement ? void 0 : u.isElement(b)) || (R = f.floating[y] || l.floating[m]);
                        let k = R / 2 - g[m] / 2 - 1,
                            ...
                            A = R / 2 - g[m] / 2 + (x / 2 - v / 2),
                            D = (0, r.uZ)(L, A, T),
                            E = !c.arrow && null != (0, r.hp)(o) && A !== D && l.reference[m] / 2 - (A < L ? L : F) - g[m] / 2 < 0,
                            O = E ? A < L ? A - L : A - T : 0;
                        return {
                            [h]: p[h] + O,
                            data: {
                    ...
                    return void 0 === t && (t = {}), {
                        ...
                        fn(e) {
                            let {
                                ...
                                x: n,
                                y: i
                            }, d = (0, r.Qq)(o), p = (0, r.Rn)(d), h = s[p], m = s[d], g = (0, r.ku)(f, e), w = "number" == typeof g ? {
                                mainAxis: g,
                                crossAxis: 0
                            } : {
                                mainAxis: 0,
                            ...
                            if (a) {
                                ...
                                let t = "y" === p ? "width" : "height",
                                    ...
                                    n = l.reference[d] - l.floating[t] + (e && (null == (y = u.offset) ? void 0 : y[d]) || 0) + (e ? 0 : w.crossAxis),
                                    i = l.reference[d] + l.reference[t] + (e ? 0 : (null == (x = u.offset) ? void 0 : x[d]) || 0) - (e ? w.crossAxis : 0);
                                m < n ? m = n : m > i && (m = i)
                            }
                            return {
                                [p]: h,
        ...
        97859: function(t, e, n) {
            ...
            function s(t) {
                ...
                u(v, s) || b(s);
                let [R, k] = i.useState(null), [L, F] = i.useState(null), T = i.useCallback(t => {
                    t !== O.current && (O.current = t, k(t))
                }, []), A = i.useCallback(t => {
                    t !== P.current && (P.current = t, F(t))
                }, []), D = p || R, E = h || L, O = i.useRef(null), P = i.useRef(null), C = i.useRef(y), V = null != g, S = a(g), M = a(d), K = a(w), W = i.useCallback(() => {
                    ...
                    M.current && (t.platform = M.current), (0, r.oo)(O.current, P.current, t).then(t => {
                        let e = { ...t,
                            isPositioned: !1 !== K.current
                        };
                        z.current && !u(C.current, e) && (C.current = e, o.flushSync(() => {
                            x(e)
                        }))
                    })
                }, [v, e, n, M, K]);
                l(() => {
                    !1 === w && C.current.isPositioned && (C.current.isPositioned = !1, x(t => ({ ...t,
                        isPositioned: !1
                    })))
                }, [w]);
                let z = i.useRef(!1);
        ...
        94046: function(t, e, n) {
            ...
            function a(t) {
                return !!r() && "undefined" != typeof ShadowRoot && (t instanceof ShadowRoot || t instanceof o(t).ShadowRoot)
            }
            ...
            n.d(e, {
                ...
                Kx: function() {
                    return function t(e, n, r) {
                        ...
                        let l = function t(e) {
                                let n = v(e);
                                return w(n) ? e.ownerDocument ? e.ownerDocument.body : e.body : c(n) && s(n) ? n : t(n)
                            }(e),
                            u = l === (null == (i = e.ownerDocument) ? void 0 : i.body),
                            f = o(l);
                        if (u) {
                            let e = b(f);
                            return n.concat(f, f.visualViewport || [], s(l) ? l : [], e && r ? t(e) : [])
                        }
